...
class ModuleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('module.detail', [$course_id])->with('success', 'Module Successfully Created');
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        $course_id = $request->get('course_id');
        return redirect()->route('module.detail', [$course_id])->with('success', 'Module Successfully Updated');
    }
    ...
    public function destroy($id)
    {
        ...
        $module->delete();
        return redirect()->route('module.detail', [$module->course_id])->with('success', 'Module Successfully Deleted');
    }
}
